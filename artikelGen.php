	...
	echo "<p class='tabHeadline'>Artikel</p> <p class='tabHeadline'>Art.-Nr</p> <p class='tabHeadline'>Kategorie</p> <p class='tabHeadline'>Beschreibung</p> <p class='tabHeadline'>Preis</p> <p class='tabHeadline'></p>";
		for($i=0; $i < count($artikel); $i++){
			if($i % 2 == 0){ //Artikel mit Farbe 1
				echo "<p class='tabRowType1'>".$artikel[$i][1]."</p><p class='tabRowType1 hideMobile'>".$artikel[$i][0]."</p><p class='tabRowType1 mobileDelete'>".$artikel[$i][9]."</p><p class='tabRowType1'>".$artikel[$i][5]."</p><p class='tabRowType1 price'>".$artikel[$i][8]." €</p>";
			}
			else{ //Artikel mit Farbe 2
				echo "<p class='tabRowType2'>".$artikel[$i][1]."</p><p class='tabRowType2 hideMobile'>".$artikel[$i][0]."</p><p class='tabRowType2 mobileDelete'>".$artikel[$i][9]."</p><p class='tabRowType2'>".$artikel[$i][5]."</p><p class='tabRowType2 price'>".$artikel[$i][8]." €</p>";
			}
